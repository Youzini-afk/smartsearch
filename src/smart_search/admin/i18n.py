...
_JS_KEYS = [
    ...
    "providers.credential_enabled",
    "providers.base_url_custom_hint",
    "providers.base_url_openai_hint",
    "providers.base_url_optional_hint",
    "providers.testing",
    "providers.test_ok",
    "providers.test_fail",
...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "zh-CN": {
        ...
        "dashboard.provider_breakdown": "按提供商调用",
        ...
        "usage.errors": "错误数",
        "usage.by_tool": "按工具分布",
        "usage.tool_distribution": "按工具调用分布",
        ...
        "config.command_reference": "命令对照",
        "config.command_col": "命令",
        "config.total_providers": "提供商总数",
        "config.active_keys": "活跃密钥",
        "config.capability_config": "能力配置",
        "config.override_draft": "覆盖草案",
        "config.tool_commands": "工具命令",
        "config.status_all": "全部",
        "config.status_active": "活跃",
        "config.status_inactive": "非活跃",
        # providers additions
        "providers.stats_title": "提供商概览",
        "providers.total_keys": "密钥总数",
        "providers.active_keys": "活跃密钥",
        "providers.healthy": "已启用",
        "providers.attention": "需关注",
        "providers.filter_all": "全部",
        "providers.filter_active": "已启用",
        "providers.filter_attention": "需关注",
        "providers.last_used": "最近使用",
        "providers.created": "创建时间",
        "providers.security_tips": "安全提示",
        "providers.security_tip_1": "API 密钥使用 AES-256 加密存储",
        "providers.security_tip_2": "密钥仅在明确查看时解密（审计日志记录）",
        "providers.security_tip_3": "禁用不用的密钥而非删除",
        "providers.security_tip_4": "生产环境和开发环境使用不同密钥",
        "providers.add_key_drawer_title": "添加提供商密钥",
        "providers.edit_key_drawer_title": "编辑提供商密钥",
        "providers.dismiss": "关闭",
        # usage additions
        "usage.filter_bar_title": "筛选",
        "usage.filter_tool": "工具",
        "usage.filter_provider": "提供商",
        "usage.filter_date": "日期范围",
        "usage.latency_chart": "延迟分布",
        "usage.token_usage": "Token 用量",
        "usage.est_input_tokens": "估算输入 Token",
        "usage.est_output_tokens": "估算输出 Token",
        "usage.est_total_tokens": "估算总 Token",
        "usage.avg_latency_title": "平均延迟",
        "usage.p50_latency": "P50",
        "usage.p95_latency": "P95",
        "usage.p99_latency": "P99",
        "usage.no_records": "暂无调用记录",
        # dashboard additions
        "dashboard.invocation_trend": "调用趋势",
        "dashboard.period_24h": "24h",
        "dashboard.period_7d": "7d",
        "dashboard.period_30d": "30d",
        "dashboard.last_updated": "最近更新",
        "dashboard.errors_top": "错误 Top",
        "dashboard.recent_calls": "最近调用",
        "dashboard.call_id": "ID",
        "dashboard.health_score": "健康评分",
        "dashboard.configured_providers": "已配置",
        "dashboard.total_calls": "总调用数",
        # common
        "common.loading": "加载中...",
        "common.no_data": "暂无数据",
        "common.confirm": "确认",
    ...
    "en": {
        ...
        "dashboard.provider_breakdown": "Provider Calls",
        ...
        "config.command_reference": "Command Reference",
        "config.command_col": "Command",
        "config.total_providers": "Total Providers",
        "config.active_keys": "Active Keys",
        "config.capability_config": "Capability Config",
        "config.override_draft": "Override Draft",
        "config.tool_commands": "Tool Commands",
        "config.status_all": "All",
        "config.status_active": "Active",
        "config.status_inactive": "Inactive",
        # providers additions
        "providers.stats_title": "Provider Overview",
        "providers.total_keys": "Total Keys",
        "providers.active_keys": "Active Keys",
        "providers.healthy": "Active",
        "providers.attention": "Needs Attention",
        "providers.filter_all": "All",
        "providers.filter_active": "Active",
        "providers.filter_attention": "Needs Attention",
        "providers.last_used": "Last Used",
        "providers.created": "Created",
        "providers.security_tips": "Security Tips",
        "providers.security_tip_1": "API keys are encrypted at rest using AES-256",
        "providers.security_tip_2": "Keys are only decrypted when explicitly revealed (audit logged)",
        "providers.security_tip_3": "Disable unused keys instead of deleting them",
        "providers.security_tip_4": "Use separate keys for production and development",
        "providers.add_key_drawer_title": "Add Provider Key",
        "providers.edit_key_drawer_title": "Edit Provider Key",
        "providers.dismiss": "Dismiss",
        # usage additions
        "usage.filter_bar_title": "Filter",
        "usage.filter_tool": "Tool",
        "usage.filter_provider": "Provider",
        "usage.filter_date": "Date Range",
        "usage.tool_distribution": "Calls by Tool",
        "usage.latency_chart": "Latency Distribution",
        "usage.token_usage": "Token Usage",
        "usage.est_input_tokens": "Est. Input Tokens",
        "usage.est_output_tokens": "Est. Output Tokens",
        "usage.est_total_tokens": "Est. Total Tokens",
        "usage.avg_latency_title": "Avg Latency",
        "usage.p50_latency": "P50",
        "usage.p95_latency": "P95",
        "usage.p99_latency": "P99",
        "usage.no_records": "No invocation records found",
        # dashboard additions
        "dashboard.invocation_trend": "Invocation Trend",
        "dashboard.period_24h": "24h",
        "dashboard.period_7d": "7d",
        "dashboard.period_30d": "30d",
        "dashboard.last_updated": "Last updated",
        "dashboard.errors_top": "Top Errors",
        "dashboard.recent_calls": "Recent Calls",
        "dashboard.call_id": "ID",
        "dashboard.health_score": "Health Score",
        "dashboard.configured_providers": "Configured",
